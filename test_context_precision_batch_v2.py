"""
RAGAS Context Precision Test for Flynas Chatbot - V2 (Enhanced Anti-Detection)
...
V2 Improvements:
- playwright-stealth for comprehensive fingerprint masking
- Increased wait times (15-20s)
- Scroll behavior before interacting
"""
    ...
    async def send_message(self, message: str) -> ChatbotResponse:
        ...
        try:
            ...
            for char in message:
                ...
                delay = random.uniform(40, 130) / 1000  # 40-130ms
                if char in ' .,?!':
                    delay = random.uniform(100, 250) / 1000  # Longer pause after punctuation/space
            ...
            # INCREASED wait time for response (15-20s instead of 12-15s)
...
async def main():
    print("=" * 60)
    print("RAGAS Context Precision Test - Flynas Chatbot (V2)")
    print("(Enhanced Anti-Detection: stealth + scroll + longer wait)")
    print("=" * 60)
    ...
    try:
        ...
        for i, question in enumerate(TEST_QUESTIONS, 1):
            ...
            # Wait 5-7 seconds between sessions (slightly longer)
